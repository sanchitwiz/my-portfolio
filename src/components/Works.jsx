    ...
    >
      ...
      >
        <div className="relative w-full h-[230px] ">
          ...
          <div className="absoulte flex justify-end inset-0 card-img_hover ">
            <div
    ...
    <>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sunt qui nobis, consequuntur sed, quae corporis dolorum incidunt ut laudantium repellat dolore voluptates eius ipsam exercitationem perferendis quas earum culpa aut!
        </motion.div>
      </div>
