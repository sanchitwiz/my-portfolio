...
function Hero() {
  return (
    <section className='relative w-full min-h-screen mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[80px] max-w-7xl mx-auto flex flex-col items-start gap-5 sm:flex-row`}>
      ...
      <ComputersCanvas style={{ backgroundColor: 'red', border: '2px solid blue' }} />
